...
/*
  ...
  Description: CPT Export was build to export large amount of custom post type posts from one website to another.
  Version: 1.0
  Author: SF2
...
class CPTExport {
    ...
    function create_menus() {
        ...
        add_management_page(
                __("CPT Export"), __("CPT Export"), "export", "dms3export", array($this, "admin_page")
        );
    }
